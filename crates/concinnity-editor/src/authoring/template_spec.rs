...
// `concinnity_world::spec` (a build-side crate, kept out of the shipped
...
use concinnity_world::template::WorldTemplate;
...
mod tests {
    ...
    fn world_template_entries_yields_world_lines() {
        let template = concinnity_world::template::TEMPLATES
            .first()
