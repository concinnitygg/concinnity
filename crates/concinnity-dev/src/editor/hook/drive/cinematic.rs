...
impl EditorHook {
    ...
    pub(in crate::editor::hook) fn drive_cinematic(&mut self, world: &mut World) {
        if !self.start_mode {
    ...
    pub(in crate::editor::hook) fn drive_cinematic_draw(
        &self,
        world: &mut World,
        vp: [f32; 2],
        shown: bool,
    ...
    pub(in crate::editor::hook) fn stop_cinematic(&mut self, world: &mut World) {
