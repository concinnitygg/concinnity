...
impl EditorHook {
    ...
    // (no camera).
    pub(in crate::editor::hook) fn open_create_menu(
        &mut self,
        input: &FrameInput,
        vp: [f32; 2],
        world: &World,
    ...
    pub(in crate::editor::hook) fn route_create_menu_click(
        &mut self,
        input: &FrameInput,
        vp: [f32; 2],
    ) -> bool {
    ...
    pub(in crate::editor::hook) fn drive_create_menu_draw(
        &self,
        world: &mut World,
        shown: bool,
        mouse: [f32; 2],
