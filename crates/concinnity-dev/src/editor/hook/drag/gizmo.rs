...
pub(in crate::editor::hook) fn round3(v: f32) -> f32 {
...
pub(in crate::editor::hook) struct GizmoDrag {
    axis: usize,
...
impl EditorHook {
    pub(in crate::editor::hook) fn member_target(
        &self,
        world: &World,
        mode: GizmoMode,
        name: &str,
    ...
    pub(in crate::editor::hook) fn gizmo_layout(
        &self,
        world: &World,
        vp: [f32; 2],
    ) -> Option<gizmo::Layout> {
    ...
    pub(in crate::editor::hook) fn try_gizmo_press(
        &mut self,
        input: &FrameInput,
        vp: [f32; 2],
        world: &mut World,
    ...
    pub(in crate::editor::hook) fn drive_gizmo_drag(
        &mut self,
        input: &FrameInput,
        vp: [f32; 2],
        world: &mut World,
    ...
    pub(in crate::editor::hook) fn drive_gizmo_draw(
        &self,
        world: &mut World,
        vp: [f32; 2],
        shown: bool,
