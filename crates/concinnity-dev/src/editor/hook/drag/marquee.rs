...
impl EditorHook {
    pub(in crate::editor::hook) fn begin_marquee(&mut self, anchor: [f32; 2], additive: bool) {
    ...
    pub(in crate::editor::hook) fn drive_marquee(
        &mut self,
        input: &FrameInput,
        vp: [f32; 2],
        world: &mut World,
    ...
    pub(in crate::editor::hook) fn drive_marquee_draw(&self, world: &mut World, shown: bool) {
        match &self.marquee {
