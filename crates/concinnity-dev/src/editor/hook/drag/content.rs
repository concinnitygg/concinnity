...
pub(in crate::editor::hook) struct DropPose {
    pub position: [f32; 3],
    pub normal: [f32; 3],
...
pub(in crate::editor::hook) fn align_rotation(axis: usize, sign: f32) -> [f32; 3] {
    match (axis, sign > 0.0) {
        (0, true) => [0.0, 0.0, -90.0],
...
impl EditorHook {
    ...
    pub(in crate::editor::hook) fn drive_content_drag(
        &mut self,
        input: &FrameInput,
        vp: [f32; 2],
        world: &mut World,
    ...
    pub(in crate::editor::hook) fn drop_point(
        &self,
        world: &World,
        vp: [f32; 2],
        mouse: [f32; 2],
    ...
    fn drop_pose(
        ...
        let hit = world
            ...
            .filter_map(|e| concinnity_core::math::pick::ray_aabb_face(&ray, e.bb_min, e.bb_max))
    ...
    fn ray_hit_names(
        &self,
        world: &World,
        ray: &concinnity_core::math::pick::PickRay,
    ) -> Vec<String> {
        ...
        let mut hits: Vec<(f32, String)> = index
            ...
            .iter()
            .filter_map(|e| {
                let t = concinnity_core::math::pick::ray_aabb(ray, e.bb_min, e.bb_max)?;
    ...
    pub(in crate::editor::hook) fn drive_content_ghost(&self, world: &mut World, vp: [f32; 2]) {
