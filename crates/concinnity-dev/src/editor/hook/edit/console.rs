...
impl EditorHook {
    ...
    pub(in crate::editor::hook) fn drive_console_toggle(
        &mut self,
        input: &FrameInput,
        world: &mut World,
    ) {
    ...
    pub(in crate::editor::hook) fn console_window(
        &self,
    ) -> (Vec<console::ConsoleLine>, usize, usize) {
    ...
    pub(in crate::editor::hook) fn make_console_view<'a>(
        &self,
