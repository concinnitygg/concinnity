...
impl EditorHook {
    ...
    pub(in crate::editor::hook) fn entry_args(
        &self,
        idx: usize,
    ...
    pub(in crate::editor::hook) fn lighting_present(&self) -> Vec<bool> {
        lighting::SECTIONS
            .iter()
    ...
    pub(in crate::editor::hook) fn lighting_data(&self) -> LightingData {
        LightingData {
    ...
    pub(in crate::editor::hook) fn make_lighting_view<'a>(
        &'a self,
        d: &'a LightingData,
        mouse: [f32; 2],
    ) -> LightingView<'a> {
    ...
    pub(in crate::editor::hook) fn apply_lighting_action(
        &mut self,
    ...
    pub(in crate::editor::hook) fn toggle_lighting_bool(&mut self, b: usize) {
    ...
    pub(in crate::editor::hook) fn add_lighting_section(&mut self, si: usize, world: &mut World) {
