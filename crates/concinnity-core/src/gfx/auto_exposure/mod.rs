//! Auto-exposure: the tunables the post-process config resolves into, the
//! luminance histogram the backends measure a frame with, and the running EMA
//! that turns that measurement into the next frame's exposure.
