...
//
// `concinnity_physics::Fanout` is generic in the item and the body so a step's
...
mod tests {
    use super::*;
    use concinnity_physics::{ColliderShape, DynamicParams, LayerMask};

    fn falling() -> (Simulation, concinnity_physics::BodyHandle) {
