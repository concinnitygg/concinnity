...
macro_rules! for_each_component {
    ($cb:ident) => {
        $cb! {
            ...
            Prop              => $crate::assets::Prop { gen, external, id, renders, validate: prop, refs: [("scene", "Scene"), ("parent", "Prop")] },
            ...
            InstancedProp     => $crate::assets::InstancedProp { gen, external, id, renders, validate: instanced_prop },
            ...
            VoxelWorld        => $crate::assets::VoxelWorld { gen, external, renders },
            ...
            StatHud           => $crate::assets::StatHud { gen, external, renders },
            ...
            DebugHud          => $crate::assets::DebugHud { gen, external, renders },
