...
/// build bakes the source into a color cube; the graded result is blended over
...
/// present, color grading is skipped regardless of `lut_strength`.
///
...
///
/// ```rust
/// # use concinnity_core::components::ColorLut;
/// ColorLut {
