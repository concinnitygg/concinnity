...
// `hud`) or subsystem crate (`concinnity_physics`, `concinnity_audio`),
...
// `crate::assets::shader::ShaderKind`,
...
// a resource.)
pub use concinnity_core::assets::{procedural_mesh, sdf_volume, shader};
