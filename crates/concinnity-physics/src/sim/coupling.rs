// concinnity-physics/src/sim/coupling.rs
//
...
///
/// [`SimConfig::sleep_linear_velocity`]: crate::SimConfig::sleep_linear_velocity
...
impl Coupling {
    ...
    fn sweep(
        ...
        for i in 0..MAX_MANIFOLD_POINTS {
            ...
            moved = moved.max(libm::fabsf(change) * self.rows[i][i]);
        }
        moved
    }
}
