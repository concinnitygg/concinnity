// concinnity-physics/src/sim/joint/constraint.rs
//
...
use crate::sim::solver::{Bodies, SolverBody};
...
mod tests {
    ...
    fn identity_error() -> Vec3 {
        twist_error(
            &JointFrame::new(crate::JointSpec::Fixed, Quat::IDENTITY, Quat::IDENTITY),
            Quat::IDENTITY,
            Quat::IDENTITY,
        )
    }
    ...
    fn a_joint_at_the_pose_it_was_made_at_has_no_twist_to_correct() {
        ...
        let frame = JointFrame::new(crate::JointSpec::Fixed, a, b);
    ...
    fn the_twist_error_is_the_turn_that_puts_the_body_back() {
        let frame = JointFrame::new(crate::JointSpec::Fixed, Quat::IDENTITY, Quat::IDENTITY);
