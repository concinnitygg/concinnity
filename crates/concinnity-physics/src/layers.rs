// concinnity-physics/src/layers.rs
//
// Named collision layers over Rapier's 32-bit interaction groups. Four
// built-in layers cover the engine's body kinds; a world's PhysicsConfig may
// declare up to 28 more and disable pairs symmetrically via `no_collide`.
