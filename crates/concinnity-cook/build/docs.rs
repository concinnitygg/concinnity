...
// Bake the asset reference into `$OUT_DIR/assets_doc.rs`, which `src/docs`
// includes.
pub(crate) fn generate() {
    println!("cargo:rerun-if-changed=build/docs.rs");
...
fn write_assets_doc(reference: &Reference) {
    ...
    out.push_str("// Auto-generated by concinnity-cook/build/docs.rs - do not edit.\n\n");
