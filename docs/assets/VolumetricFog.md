...
- `color`: An array of 3 floats. Linear-space RGB tint of the fog: the color the camera sees in the far distance. Defaults to `[0.7, 0.78, 0.85]`.
...
- `ambient`: A float. Constant ambient brightness so the fog keeps some color in shaded areas. Defaults to `0.15`.
