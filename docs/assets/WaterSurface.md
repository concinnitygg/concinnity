...
- `deep_color`: An array of 3 floats. Linear-space RGB colour of deep water. Defaults to `[0.02, 0.05, 0.15]`.
- `shallow_color`: An array of 3 floats. Linear-space RGB colour of shallow water near the shore. Defaults to `[0.20, 0.50, 0.55]`.
