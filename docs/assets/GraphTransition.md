...
- `conditions`: An array of [GraphCondition](GraphCondition.md) objects. Conditions that must all pass (in addition to any `exit_time` gate). An empty list always passes.
