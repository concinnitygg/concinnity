...
- `bounds_min`: An array of 3 floats. AABB minimum corner the camera center must stay inside [x, y, z]. Defaults to `[-1000000000.0, -1000000000.0, -1000000000.0]`.
- `bounds_max`: An array of 3 floats. AABB maximum corner the camera center must stay inside [x, y, z]. Defaults to `[1000000000.0, 1000000000.0, 1000000000.0]`.
