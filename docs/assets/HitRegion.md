...
- `action`: A string. Action to fire on click: `"quit"`, `"scene:<name>"`, `"screen:show:<name>"`, `"screen:push:<name>"`, `"screen:toggle:<name>"`, `"screen:hide"`, or a `"story:<verb>"` (`start`, `continue`, `advance`, `choose:<i>`, `slot:<i>`, `auto`, `skip`, `log`, `save`, `load`, `pause`, `settings`, `settings_back`). Empty fires nothing. A malformed action fails the build. Optional.
