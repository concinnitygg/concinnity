...
- `material`: A string. A [Material](Material.md) providing the albedo texture plus lighting parameters. Optional.
- `instances`: An array of [InstanceTransform](InstanceTransform.md) objects. Per-instance transforms. Empty list renders nothing. Defaults to `[]`.
