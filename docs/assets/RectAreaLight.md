...
- `normal`: An array of 3 floats. Direction the panel emits. Normalized on load; defaults to `+Z` when degenerate.
...
- `intensity`: A float. Intensity multiplier applied to the color. Defaults to `12.0`.
